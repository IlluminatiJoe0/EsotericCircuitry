...
public class ModMenuTypes {
    public static final DeferredRegister<MenuType<?>> MENUS =
            DeferredRegister.create(ForgeRegistries.MENU_TYPES, EsotericCircuitry.MOD_ID);

    public static final RegistryObject<MenuType<MaterializerMenu>> MATERIALIZER_MENU =
            registerMenuType("materializer_menu", MaterializerMenu::new);
